...
public class MainActivity extends AppCompatActivity {
    ...
    private class JsBridge {
        ...
        public void onFullscreen() {
            runOnUiThread(MainActivity.this::enterFullscreen);
        }
    }
    ...
    private void initListeners() {
        ...
        btnParse.setOnClickListener(v -> {
            ...
            if (url.isEmpty()) {
                Toast.makeText(MainActivity.this, "请先输入视频链接", Toast.LENGTH_SHORT).show();
                return;
            }
            startActivity(new Intent(MainActivity.this, ParseResultActivity.class).putExtra("url", url));
        });
    ...
    private class ImagePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(android.view.ViewGroup container, int position) {
            ZoomableImageView page = new ZoomableImageView(MainActivity.this, onTap, onLongPress, zoomEnabled);
    ...
    private void saveImages() {
        ...
        executor.execute(() -> {
            ...
            mainHandler.post(() -> {
                layoutSaveProgress.setVisibility(View.GONE);
                btnSave.setEnabled(true);
                Toast.makeText(MainActivity.this, saved > 0 ? ("已保存 " + saved + " 张图片") : "图片保存失败", Toast.LENGTH_SHORT).show();
            });
        });
    }
